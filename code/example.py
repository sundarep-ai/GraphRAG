"""
Simple example demonstrating GraphRAG usage.
"""
import os
from graph_rag import GraphRAG

def simple_example():
    """Simple example of using GraphRAG."""
    
    # Initialize GraphRAG
    print("Initializing GraphRAG system...")
    graph_rag = GraphRAG()
    
    # Example: Compare two relationship descriptions
    print("\nComparing relationship descriptions:")
...
def load_and_analyze_existing_data():
    ...
    relationships_file = "../output_data/graph_data/relationships_v4.csv"
    ...
    if os.path.exists(relationships_file):
        ...
        print(f"- Cards covered: {stats['cards_covered']}")
